...
```
[root@chunk1 ~]# dnf install moosefs-chunkserver -y
...
```
[root@web ~]# dnf install moosefs-client -y
...
```
[root@web mnt]# touch oui /mnt/www/
[root@web mnt]# cd 
www/  
[root@web mnt]# cd www/
[root@web www]# ls
oui.txt
[root@web www]# cat oui.txt
oui
[root@web www]# touch non
[root@web www]# ls
oui.txt  non
```
...
```
[root@web www]# dnf install nginx -y
